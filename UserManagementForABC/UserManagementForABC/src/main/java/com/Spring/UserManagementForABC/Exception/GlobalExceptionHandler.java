...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleDemoException(SystemException ex) {
        HttpStatus status = switch (ex.getErrorCode()) {
            ...
            case TOKEN_NOT_FOUND, TOKEN_EXPIRED, TOKEN_NOT_VALID, TOKEN_TYPE_MISMATCH, INVALID_CREDENTIALS, LOGIN_FAILED, NOT_AUTHENTICATED, INVALID_TOKEN, LOGOUT_FAILED -> HttpStatus.UNAUTHORIZED;
        };
